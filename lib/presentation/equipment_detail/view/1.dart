              ...
              children: [
                Form(
                  ...
                  child: Column(
                    children: [
                      CustomTextField(
                        requestViewModel.employeeNameController,
                        labelText: 'full name',
                        required: true,
                        validator: (value) {
                      ...
                      CustomTextField(
                        requestViewModel.dateController,
                        labelText: 'date',
                        required: true,
                        validator: (value) {
                          if (value!.isEmpty || value.trim().isEmpty) {
                            return 'Please date today (mm-dd-yyyy).';
                          }
                          return null;
                        },
                      ),
                      CustomTextField(
                        requestViewModel.purposeController,
                        labelText: 'purpose',
                        required: true,
                        validator: (value) {
                          if (value!.isEmpty || value.trim().isEmpty) {
                            return 'Please purpose of request';
                          }
                          return null;
                        },
                      ),
